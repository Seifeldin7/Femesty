...
export const SplashScreen = ({navigation} : componentProps) => {
    ...
    return (
      ...
      <View style={styles.header}>
          <Animatable.Image 
              animation="bounceIn"
              duration={1000}
          source={require('../../assets/icons/svg/app_icon.svg')}
          style={styles.logo}
          resizeMode="stretch"
          />
      </View>
      ...
      >
          ...
          <TouchableOpacity onPress={()=>navigation.navigate('ConnectedLoginScreen')}>
